...
docker-compose down
log_success "Containers parados com sucesso!"

# Remover volumes (opcional, descomente se necessário)
# log_info "Removendo volumes..."
# docker-compose down -v
# log_success "Volumes removidos com sucesso!"

# Reconstruir e iniciar os containers
log_info "Reconstruindo e iniciando containers..."
