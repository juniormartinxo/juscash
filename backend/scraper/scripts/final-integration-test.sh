...
test_api_endpoints() {
    ...
    test_publication='{"process_number":"TEST-'$(date +%s)'-89.2024.8.26.0100","availability_date":"2024-03-17T00:00:00.000Z","authors":["Test Author"],"content":"Test content aposentadoria benefício","defendant":"Instituto Nacional do Seguro Social - INSS"}'
...
test_data_persistence() {
    ...
    test_publication="{\"process_number\":\"$test_process\",\"availability_date\":\"2024-03-17T00:00:00.000Z\",\"authors\":[\"Persistence Test\"],\"content\":\"Test persistence aposentadoria benefício\",\"defendant\":\"Instituto Nacional do Seguro Social - INSS\"}"
